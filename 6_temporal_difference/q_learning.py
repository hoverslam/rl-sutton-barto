...
def q_learning(env, gamma=1.0, alpha=0.1, epsilon=0.1, episodes=10000):
    ...
    for e in tqdm(range(episodes)):
        ...
        while not done:
            ...
            td_target = reward + gamma * Q[next_state[0]][next_state[1]].max() * (not done)
...
Q = q_learning(env, episodes=100000)
print(get_policy(Q))